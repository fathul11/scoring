...
class User extends CI_Controller 
{
    ...
    public function index() 
    {
        ...
        $data['employee'] = $this->user->getPerson();
    ...
    public function edit()
    {
        ...
        $data['jabatan'] = $this->user->getJabatan()->result_array();

        $this->form_validation->set_rules('name','Name','required|trim');
        $this->form_validation->set_rules('jabatan','Jabatan','required|trim');
        $this->form_validation->set_rules('pangkat','pangkat','required|trim');
        $this->form_validation->set_rules('no_hp', 'No handpone', 'required|trim|numeric|max_length[12]');
        ...
        } else 
        {
            ...
            } else 
            {
                ...
                } else
                {
                    ...
                    $this->user->changePasswordUser($password_hash, $this->session->userdata('nik'));
